...
class Certificate(models.Model):
    """被保険者証の情報を管理するモデル"""
    class Meta:
        verbose_name_plura = "介護認定情報"
        ordering = ['-limit_start', '-created_at']

    user = models.ForeignKey(UseUser ,on_delete=models.CASCADE ,related_name="certificate" ,verbose_name="利用者")
    ...
    limit_amount_type = models.CharField(default="規定" ,max_length=10
