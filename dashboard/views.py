...
def init_plan(request):
    ...
    # services = [
    #     AddOnService(code='10', service_name='値引き', price=-1000, unit=1, category='自費', is_tax=False, insurance_type='insurance', apply_unit='per_service', medical_deduction=False),
    #     AddOnService(code='11', service_name='時間サービス', price=1000, unit=1, category='自費', is_tax=False, insurance_type='insurance', apply_unit='per_service', medical_deduction=False),
    #     AddOnService(code='12', service_name='昼食代', price=690, unit=1, category='食費', is_tax=False, insurance_type='insurance', apply_unit='per_day', medical_deduction=False),
    #     AddOnService(code='13', service_name='おやつ代', price=150, unit=1, category='食費', is_tax=False, insurance_type='insurance', apply_unit='per_day', medical_deduction=False),
    #     AddOnService(code='14', service_name='洗濯代', price=120, unit=1, category='自費', is_tax=False, insurance_type='insurance', apply_unit='per_day', medical_deduction=False),
    #     AddOnService(code='15', service_name='教養娯楽費', price=50, unit=1, category='自費', is_tax=False, insurance_type='insurance', apply_unit='per_day', medical_deduction=False),
    #     AddOnService(code='16', service_name='パット代', price=100, unit=1, category='消耗品', is_tax=True, insurance_type='insurance', apply_unit='per_service', medical_deduction=False),
    #     AddOnService(code='17', service_name='キャンセル料', price=1000, unit=1, category='自費', is_tax=False, insurance_type='insurance', apply_unit='per_service', medical_deduction=False),
    #     AddOnService(code='3', service_name='時間サービス', price=1500, unit=1, category='自費', is_tax=True, insurance_type='insurance', apply_unit='per_service', medical_deduction=False),
    #     AddOnService(code='5', service_name='昼食代B', price=500, unit=1, category='食費', is_tax=True, insurance_type='insurance', apply_unit='per_day', medical_deduction=False),
    #     AddOnService(code='6', service_name='夕食代', price=690, unit=1, category='食費', is_tax=False, insurance_type='insurance', apply_unit='per_day', medical_deduction=False),
    #     AddOnService(code='7', service_name='宿泊費', price=6800, unit=1, category='宿泊', is_tax=True, insurance_type='insurance', apply_unit='per_service', medical_deduction=False),
    #     AddOnService(code='8', service_name='宿泊費B', price=3500, unit=1, category='宿泊', is_tax=True, insurance_type='insurance', apply_unit='per_service', medical_deduction=False),
